...
FTP_USERNAME = "root"
FTP_PASSWORD = ""
REMOTE_PATH = "/config/ryazhahand/notifications/"
...
def generate_and_upload_notify(text, font_size=28):
    ...
    filename = f"ryazhahand_notify-{timestamp}.notify"
...
def print_banner():
    banner = """
  \033[37mryazha\033[31mhand\033[0m \033[35mnotify\033[0m \033[37m¯\\_(ツ)_/¯ \033[0m
...
if __name__ == "__main__":
    if len(sys.argv) >= 2 and sys.argv[1] == "-i":
        ...
        if len(sys.argv) < 2:
            print("Usage: python3 ryazhahand_notify.py 'Your notification text here' [font_size]")
            print("   or: python3 ryazhahand_notify.py -i   (interactive mode)")
            sys.exit(1)
