 ...
 *   throughout the Ryzhand Overlay project. These constants are essential for 
...
namespace ult {
    ...
    const std::string LATEST_UPDATER_INI_URL        = GITHUB_RAW_BASE_URL + "Ryazhahand-Overlay/main/update.ini";
    ...
    //const std::string SOUND_EFFECTS_URL             = GITHUB_RAW_BASE_URL + "Ryzhand-Overlay/main/sounds/sounds.zip";
