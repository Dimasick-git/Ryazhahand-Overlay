...
namespace ult {
    ...
    extern std::string HOME_LED_GLOW;
    ...
    // Color filter system
    extern std::atomic<int> wallpaperColorFilter; // 0=none, 1=red, 2=green, 3=blue, 4=sepia, 5=invert
    extern std::atomic<bool> cycleColorFilter;   // Auto-cycle filters
