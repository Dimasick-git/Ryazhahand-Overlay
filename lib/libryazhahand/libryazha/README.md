...
![Ryzhand Logo](https://github.com/ppkantorski/Ryzhand-Overlay/blob/main/.pics/ryazhahand.png)


## Overview

`libryazha` is a powerful collection of helper functions designed specifically for the Ryzhand Overlay project. This library offers a comprehensive set of utilities aimed at simplifying common tasks and enhancing the efficiency of your projects within the Ryzhand Overlay ecosystem.

## Features

### [Ryz Header](/libryazha/include/ryz.hpp)

- **ryz.hpp**: The main header file for the `libryazha` library, including all essential functions and declarations for seamless integration into your projects.

### [Debug Functions](/libryazha/include/debug_funcs.hpp)
...
### [Hex Functions](/libryazha/include/hex_funcs.hpp)
...
### [INI Functions](/libryazha/include/ini_funcs.hpp)
...
### [JSON Functions](/libryazha/include/json_funcs.hpp)
...
### [List Functions](/libryazha/include/list_funcs.hpp)
...
### [Mod Functions](/libryazha/include/mod_funcs.hpp)
...
### [Path Functions](/libryazha/include/path_funcs.hpp)
...
### [String Functions](/libryazha/include/string_funcs.hpp)
...
To build Ryzhand overlays with `libryazha` + `libtesla`, simply add the `lib` folder to your project, then import `tesla.hpp`.

## Contribution

Contributions to `libryazha` are welcome. If you have ideas for additional helper functions or improvements to existing ones, feel free to submit a pull request or open an issue on GitHub.
